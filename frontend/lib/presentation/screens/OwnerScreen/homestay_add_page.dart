...
class HomestayAddPageState extends State<HomestayAddPage> {
  ...
  final categories   = ['homestay', 'guest_house', 'traditional', 'Heritage Home'];
  final allAmenities = [
  ...
  Widget categoryDropdown(bool wide) => Padding(
    ...
    child: DropdownButtonFormField<String>(
      ...
      hint: Text('Select Category', style: GoogleFonts.dmSans(fontSize: ffs(14, wide))),
      ...
      items: {
        ...
        child: Text(
          c == 'homestay' ? 'Homestay' :
          c == 'guest_house' ? 'Guest House' :
          c == 'traditional' ? 'Traditional' : c,
          style: GoogleFonts.dmSans(fontSize: ffs(14, wide)),
        ),
      )).toList(),
