// lib/presentation/screens/TouristScreen/TouristHomestayDetailPage.dart
//
// CHANGE: AppBar actions heart icon replaced with FavouriteButton(homestayId: _model.id)
// Everything else is identical to what you shared.
...
class TouristHomestayDetailPage extends StatefulWidget {
  ...
  @override
  State<TouristHomestayDetailPage> createState() =>
      _TouristHomestayDetailPageState();
}

class _TouristHomestayDetailPageState
    extends State<TouristHomestayDetailPage> {
  ...
  void initState() {
    ...
    if (_model.nearCulturalSite != null) {
      ...
      context
          .read<SitesBloc>()
          .add(LoadSiteById(_model.nearCulturalSite!.id));
    }
  }
  ...
  Widget build(BuildContext context) {
    final images =
    _model.imageUrls.isNotEmpty ? _model.imageUrls : <String>[];
        ...
        body: CustomScrollView(
          slivers: [
            ...
            SliverAppBar(
              ...
              actions: [
                // ── CHANGE: FavouriteButton replaces the old heart IconButton
                Container(
                  margin: EdgeInsets.all(8.w),
                  ...
                  children: [
                    ...
                    Row(children: [
                      Icon(Icons.star_rounded,
                          color: const Color(0xFFC7A26B), size: 16.sp),
                      SizedBox(width: 4.w),
                      Text('4.7',
                          style: GoogleFonts.dmSans(
                              fontSize: 13.sp,
                        ...
                        children: [
                          Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 2.h),
                                Text(
                                    'Rs. ${_model.pricePerNight.toStringAsFixed(0)}',
                                    style: GoogleFonts.dmSans(
                                        fontSize: 26.sp,
                                        color: _terracotta,
                    ...
                    Row(children: [
                      Expanded(child: _StatTile(
                          ...
                          value: '${_model.numberOfRooms}',
                          label: 'Rooms')),
                      SizedBox(width: 10.w),
                      Expanded(child: _StatTile(
                          icon: Icons.people_outline_rounded,
                          value: '${_model.maxGuests}',
                          label: 'Guests')),
                      SizedBox(width: 10.w),
                      Expanded(child: _StatTile(
                    ...
                    if (_model.culturalExperiences.isNotEmpty) ...[
                      ...
                      _InfoCard(
                        child: Column(
                          children: _model.culturalExperiences
                              .map((e) => Padding(
                        ...
                        _InfoCard(
                          child: Row(children: [
                            Container(
                              ...
                              child: Icon(Icons.temple_hindu,
                                  color: _terracotta, size: 24.sp),
                            ),
                            SizedBox(width: 12.w),
                            Expanded(
                              child: Text(_model.nearCulturalSite!.name,
                                  style: GoogleFonts.dmSans(
                                      fontSize: 14.sp,
                                      fontWeight: FontWeight.bold,
                                      color: _dark)),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () => Navigator.push(context,
                            MaterialPageRoute(
                                builder: (_) =>
                                    BookingFormPage(homestay: _model))),
        ...
        child: Row(children: [
          CircleAvatar(
            ...
            child: Icon(Icons.person_off_outlined,
                color: Colors.grey[400], size: 26.sp),
          ),
          SizedBox(width: 14.w),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                Text(
                    'The host account for this homestay has been removed.',
                    style: GoogleFonts.dmSans(
                        fontSize: 12.sp,
        ...
        if (!hasPhone) ...[
          ...
          Container(
            ...
            child: Row(children: [
              ...
              SizedBox(width: 8.w),
              Expanded(
                child: Text('Contact details not available for this host.',
                    style: GoogleFonts.dmSans(
                        fontSize: 12.sp, color: Colors.amber[800])),
              ),
            ]),
          ),
        ],
