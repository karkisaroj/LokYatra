...
class DiscoverPlay extends StatefulWidget {
  const DiscoverPlay({super.key});

  @override
  State<DiscoverPlay> createState() => _DiscoverPlayState();
}

class _DiscoverPlayState extends State<DiscoverPlay> {
              ...
              children: [
                ...
                ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor:Colors.redAccent,foregroundColor:Colors.black,shape: const RoundedRectangleBorder(borderRadius: BorderRadiusGeometry.all(Radius.circular(10))),elevation: 14,padding: const EdgeInsets.symmetric(horizontal: 50, vertical: 10),),
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("Get Started", style: TextStyle(fontSize: 14.sp,color: Colors.white),selectionColor: Color(
                          0xFFFFFFFF)),
