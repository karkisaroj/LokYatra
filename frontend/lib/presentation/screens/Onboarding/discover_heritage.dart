...
import 'package:lokyatra_frontend/presentation/screens/Onboarding/discover_homestay.dart';
...
class OnboardingHeritage extends StatefulWidget {

   OnboardingHeritage({super.key});

  @override
  State<OnboardingHeritage> createState() => _OnboardingHeritageState();
}

class _OnboardingHeritageState extends State<OnboardingHeritage> {
  int _currentPage=0;
            ...
            child: Row(
              ...
              ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor:Colors.white,foregroundColor:Colors.black,
                ...
                ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor:Colors.redAccent,foregroundColor:Colors.black,shape: const RoundedRectangleBorder(borderRadius: BorderRadiusGeometry.all(Radius.circular(10))),elevation: 14,padding: const EdgeInsets.symmetric(horizontal: 50, vertical: 10),),
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>DiscoverHomestay()));
                  },
                  child: Row(
