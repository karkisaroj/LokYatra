...
class SiteFavButton extends StatefulWidget {
  ...
  /// Call this to toggle the saved state from an external widget.
  static Future<void> toggleSite(int siteId) => _SiteCache.instance.toggle(siteId);
...
class _SiteFavButtonState extends State<SiteFavButton> {
  ...
  @override
  void didUpdateWidget(covariant SiteFavButton oldWidget) {
