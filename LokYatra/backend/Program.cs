...
builder.Services.AddOpenApi(options =>
{
    options.AddDocumentTransformer((document, context, cancellationToken) =>
    {
        ...
        // Use Railway-provided domain if available, otherwise let Scalar auto-detect from request
        ...
        if (!string.IsNullOrEmpty(railwayDomain))
        {
            ...
            {
                new Microsoft.OpenApi.Models.OpenApiServer { Url = $"https://{railwayDomain}" }
            };
        }
