...
import 'package:lokyatra_frontend/presentation/screens/TouristScreen/quiz_page.dart';
...
class _TouristHomeState extends State<TouristHome> {
  ...
  Widget build(BuildContext context) {
    final pages = [
      FocusScope(child: _HomeTab(onTabSwitch: _goToTab, isActive: _tab == 0)),
...
class _HomeTab extends StatefulWidget {
  ...
  final bool isActive;
  const _HomeTab({required this.onTabSwitch, required this.isActive});
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () => SiteFavButton.toggleSite(site.id),
                    child: Container(
